...
買い物や映画などのデートを一緒にする関係のパパのことです。
#### <i class="fa fa-square link-color"></i> 太P（ふとぴー）／太パパ
金払いの良いパパのことです。
#### <i class="fa fa-square link-color"></i> 良P（りょうぴー）
常識のあるストレスフリーなパパのことです。反対に肉体関係を迫ってきたりするパパのことを「クソP」「地雷P」と言ったりします。
#### <i class="fa fa-square link-color"></i> 神パパ
お金持ちで紳士的で優しく、長期の契約もしてくれるようなパパのことです。
#### <i class="fa fa-square link-color"></i> ガチ恋パパ
...
場所はカフェなどで1時間程度行います。
#### <i class="fa fa-square link-color"></i> リピ
リピートの略で、顔合わせ後、複数回パパと会うことです。
#### <i class="fa fa-square link-color"></i> プチ
本番行為なしで性的な行為を行うことです。
#### <i class="fa fa-square link-color"></i> サポ／サポート
肉体関係のある間柄のことです。別名「体あり」「大人」「大人の関係」「大人の付き合い」「ドカタ」と言ったりします。<br>
「大人3でお願いします（肉体関係有りで3万円のお手当をください）」みたいに使います。
#### <i class="fa fa-square link-color"></i> お手当
パパ活の対価として支払うお金のことです。「交通費」「タクシー代」と言ったりもします。
#### <i class="fa fa-square link-color"></i> 回収
お手当を受け取ることです。
#### <i class="fa fa-square link-color"></i> 応援
パパ活から女性に対して金銭的援助を行うことです。
#### <i class="fa fa-square link-color"></i> アポ
会う約束をすることです。
#### <i class="fa fa-square link-color"></i> 苺（いちご）
15,000円のことです。条件のやり取りで使います。
#### <i class="fa fa-square link-color"></i> 諭吉
10,000円のことです。
#### <i class="fa fa-square link-color"></i> ホ別／穂別
ホテル代は別という意味です。「ホ別3でお願いします（ホテル代とは別に3万円のお手当をください）」みたいに使います。
#### <i class="fa fa-square link-color"></i> 円／円光
援助交際のことです。
#### <i class="fa fa-square link-color"></i> 円盤
お手当をもらって、肉体関係をもつことです。
